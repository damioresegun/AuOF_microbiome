...
# NOTE: This is a script is designed to be run via the command line not the GUI. Although it can be tweaked in a GUI to run
# NOTE: Can result in a compile loop! Recommended to use the GUI version of this script (MicrobiomeAnalysis_GUI.R)
# Author: Damilola R Oresegun
# Usage Example: Rscript MicrobiomeAnalysis_cml.R my/path/to/CombinedIsolate.biom my/path/to/the/output/folder 
#                   my/path/to/my/sample_metadata.csv png
